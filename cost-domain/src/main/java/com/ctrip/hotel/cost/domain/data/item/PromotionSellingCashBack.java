 ...
 */
@Data
public class PromotionSellingCashBack implements Item<PromotionSellingPrice> {

    private List<PromotionSellingPrice> promotionSellingPrices;
    private BigDecimal total;

    public PromotionSellingCashBack(List<PromotionSellingPrice> promotionSellingPrices) {
        this.promotionSellingPrices = promotionSellingPrices;
    }

    @Override
    public CostItemType costItemType() {
        return CostItemType.CASH_BACK_PROMOTION_SELLING_PRICE_FG;
    }
