 ...
 * @description
 * @date 2022-11-07 19:46
 */
@Data
public class RoomSellingPriceFgOrderInfo extends AbstractElementFg implements RoomSellingPrice {
    ...
    public String costItemName() {
        return CostItemType.ROOM_SELLING_PRICE_FG.getCostItemName();
    }
    ...
    public String formula() {
        return QConfigHelper.getSwitchConfigByKey(CostItemType.ROOM_SELLING_PRICE_FG.getFormulaQConfigKey(), CostItemType.ROOM_SELLING_PRICE_FG.getFormula());
    }
