 ...
 */
@Data
public class PromotionCostCashBack implements Item<PromotionCostPrice> {

    private List<PromotionCostPrice> promotionCostPrices;
    private BigDecimal total;

    public PromotionCostCashBack(List<PromotionCostPrice> promotionCostPrices) {
    ...
    public CostItemType costItemType() {
        return CostItemType.CASH_BACK_PROMOTION_COST_PRICE_FG;
    }
