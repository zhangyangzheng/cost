 ...
 */
@Data
public class PriceAmountFgInfo implements PriceAmount{
    ...
    public String formula() {
        return QConfigHelper.getSwitchConfigByKey(CostItemType.AMOUNT_FG.getFormulaQConfigKey(), CostItemType.AMOUNT_FG.getFormula());
    }
