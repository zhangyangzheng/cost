 ...
 */
@Data
public class TripPromotionSelling implements Item<PromotionSellingPrice> {

    private List<PromotionSellingPrice> promotionSellingPrices;
    private BigDecimal total;

    public TripPromotionSelling(List<PromotionSellingPrice> promotionSellingPrices) {
        this.promotionSellingPrices = promotionSellingPrices;
    }

    @Override
    public CostItemType costItemType() {
        return CostItemType.TRIP_PROMOTION_SELLING_PRICE_FG;
    }
