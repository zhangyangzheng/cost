...
@Component
public class CompareHbaseClient {
...
//  }
    ...
    public void addComparing(String referenceId, String serviceName, Object compareObj, boolean addCompareItem) throws Exception {
